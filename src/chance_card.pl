...
chance_card(card_tax_smol,  300,    'Dompet Anda bocor! Anda kehilangan $10.').
chance_card(card_tax_med,   150,    'Kena typu! Anda kecurian $50.').
chance_card(card_tax_beeg,  50,     'Rumah sakit moment! Bayar $400.').
chance_card(card_gift_smol, 200,    'Uang tercecer di jalan! Anda menemukan $5.').
chance_card(card_gift_med,  100,    'Bonus! Anda menerima $40.').
chance_card(card_gift_beeg, 20,     'Warisan! Anda mendapatkan $150.').
